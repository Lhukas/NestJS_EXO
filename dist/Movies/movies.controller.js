...
__decorate([
    ...
    __metadata("design:returntype", movies_entity_1.Movies)
], MoviesController.prototype, "getById", null);
__decorate([
    (0, common_1.Get)('/addFavoris/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", movies_entity_1.Movies)
], MoviesController.prototype, "addFavoris", null);
__decorate([
    (0, common_1.Get)('/removeFavoris/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", movies_entity_1.Movies)
], MoviesController.prototype, "removeFavoris", null);
